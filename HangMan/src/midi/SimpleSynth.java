...
public class SimpleSynth {
	...
	/**
	 * Constants representing one of the standard Midi "instruments".
	 */
	...
	public SimpleSynth() {
		...
		try {
			// It seems to take a short time for a synthesizer to start up
			// properly, so wait for 200 milliseconds to let that happen.
			Thread.sleep( 200 );
		}
